...
<head>
    ...
    <title>crud phpajax tanpaloading</title>
    <!-- Link Bootsrap -->
...
<body>
    ...
    <nav class="navbar navbar-light bg-primary">
        <a class="navbar-brand text-black" href="#"><b><h2>Data Nama Siswa</h2></b></a>
    </nav>

    <div class="container">
        <h2 align="center" style="margin: 30px;">
           BELAJAR CRUD PHPAJAX TANPA LOADING
        </h2>
    ...
    <div class="text-center mb-4 mt-3">© <?php echo date('Y'); ?> Copyright:
        <a href="index.php">Data Nama Siswa</a>
    </div>
